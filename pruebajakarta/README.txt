...
a persistence unit "pruebajakartaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "pruebajakarta/pom.xml":
...
artifact ("pruebajakarta.war") is already built. You can build
